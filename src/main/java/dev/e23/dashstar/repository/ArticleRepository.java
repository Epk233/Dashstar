...
public class ArticleRepository {
    ...
    public List<Article> findPaginated(int page, int size) throws PersistenceException {
        EntityManager em = HibernateUtil.getEntityManager();
        List<Article> articles = null;
        try {
            em.getTransaction().begin();
            articles = em.createQuery("SELECT a FROM Article a ORDER BY a.createdAt DESC", Article.class)
